...
<div class="card" style="width: 100%;">
  ...
  <div class="card-body">
  <a href="updatemakale.php?id=<?php echo $id; ?>" class="btn btn-primary buttonspace">Düzenle</a>
    <a href="deletemakale.php?id=<?php echo $id; ?>" class="btn btn-danger buttonspace">Sil</a>
  </div>
</div>
<?php 
}
